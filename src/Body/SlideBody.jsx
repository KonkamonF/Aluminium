      ...
      <div className="relative z-10 h-full max-w-7xl mx-auto px-4 md:px-10 flex items-end md:items-center">
        <div className="pb-12 md:pb-0">
          ...
          <div className="mt-6 flex items-center gap-4">
            <button onClick={prev} className="rounded-full border border-white/60 px-4 py-2 text-sm hover:bg-white hover:text-black transition">Prev</button>
            <button onClick={next} className="rounded-full border border-white/60 px-4 py-2 text-sm hover:bg-white hover:text-black transition">Next</button>
          </div>
        </div>
      </div>
